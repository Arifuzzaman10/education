        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('Custom_sms') == 'active') active @endif " href="#Custom_sms" role="tab" data-toggle="tab">@lang('system_settings.custom_sms')</a>
                    </li> 
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade @if (Session::get('twilio_settings') != 'active' && Session::get('msg91_settings') != 'active' && Session::get('HimalayaSms') != 'active'  && Session::get('Mobile_SMS') != 'active' && Session::get('textlocal_settings') != 'active' && Session::get('africatalking_settings') != 'active' && Session::get('Custom_sms') != 'active') show active @endif" id="select_sms_service">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control{{ $errors->has('reciver_no') ? ' is-invalid' : '' }}" type="text" name="reciver_no" >
                                                <label>@lang('system_settings.reciver_number')</label>
                                                <span class="focus-border"></span>
                                                @if ($errors->has('reciver_no'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $errors->first('reciver_no') }}</strong>
                                                </span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-lg-6 ">
                                            <button type="submit" class="primary-btn small fix-gr-bg" id="send_test_sms">
