                    ...
                    <div class="row">
                        ...
                        @else
                            <div class="col-lg-3 mt-30-md md_mb_20">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}" name="exam" id="examTypeId">
                            ...
                            <div class="col-lg-3 mt-30-md md_mb_20" id="examTypeBaseSubjectDiv">
                                <select class="w-100 bb niceSelect form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" id="examTypeBaseSubjectList" name="subject">
                                                    ...
                                                    <table class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                        ...
                                                        <tbody>
                                                            @foreach($mark_sheet as $data)
                                                                @php
                                                                    $totalMark = subjectPercentageMark(@$data->total_marks, @subjectFullMark($data->exam_type_id, $data->subject->id));
