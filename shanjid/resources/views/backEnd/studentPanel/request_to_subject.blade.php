    ...
    <tbody>
        ...
        @foreach ($record->unStudentSemesterWiseSubjects as $subject)
            <tr>
                ...
                <td> {{ $assignDetail['amount'] . '('.generalSetting()->currency_symbol.')' }} </td>
                <td> {{ $subject->subject->number_of_hours * $assignDetail['amount']  . '('.generalSetting()->currency_symbol.')'}}</td>
        ...
        @foreach ($record->unStudentRequestSubjects as $reqSubject)
            <tr>
                ...
                <td> {{ $assignDetail['amount'] . '('.generalSetting()->currency_symbol.')' }} </td>
                <td> {{ $reqSubject->unSubject->number_of_hours * $assignDetail['amount']  . '('.generalSetting()->currency_symbol.')'}}</td>
