                                                            ...
                                                            <td>
                                                                <label class="switch">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        class="required_switch_btn required_{{ $field->field_name }}"
    ...
    <script>
        $(document).ready(function() {
            $(".student_show_btn").on("change", function() {
                ...
                if(canChangeCheckbox(guardian_required_fields, filed_value, field_show, 'show_')==false) {
                    return;
                }
            ...
            $(".required_switch_btn").on("change", function() {
                ...
                if(canChangeCheckbox(guardian_required_fields, filed_value, field_status, 'required_')==false) {
                    return;
                }
