        ...
        <div class="row pt-20">
            ...
            <div class="col-lg-9">
                ...
                <div class="tab-content">
                    ...
                    @foreach ($paymeny_gateway_settings as $row)
                        <div role="tabpanel"
                            class="tab-pane fade   @if (@$row->gateway_name == 'PayPal') active show @endif "
                            id="{{ @$row->gateway_name }}">
                                ...
                                <div class="">
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-12">
                                            ...
                                            @if (!in_array($input_field, $forServiceCharge))
                                                <div class="row">
                                                    <div class="col-lg-12 mb-30">
                                                        <div class="input-effect">
                                                            <input
                                                                class="primary-input form-control{{ $errors->has($input_field) ? ' is-invalid' : '' }}"
                                            ...
                                            @endif
                                            @if ($input_field == 'service_charge' && teacherParentService()==true)
                                                @php
                                                ...
                                                <div class="row {{ $d_none }}" id="charge_type_{{ $row->gateway_name }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="input-effect">
                                                            <input type="number"
                                                                class="primary-input form-control chargeValue {{ $errors->has('charge') ? ' is-invalid' : '' }}"
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <table id="noSearch" class="display school-table shadow-none"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 ">
                                                        ...
                                                        <div class="input-effect sm2_mb_20">
                                                            ...
                                                            <textarea class="primary-input article-ckeditor form-control" cols="0" rows="3"
                                ...
                                @if (@$row->gateway_name != 'Bank')
                                    @if (@$row->gateway_name == 'Paystack')
                                        <strong class="main-title"> N.B: Please Set This url <a class="disabled"
                                                href="{{ route('handleGatewayCallback') }}" disable>
