...
class SmStudentAdmissionController extends Controller
{
    ...
    public function store(SmStudentAdmissionRequest $request)
    {
        ...
        $staff =  $staffParent->staff($guardians_email, $guardians_phone);
    ...
    public static function loadData()
    {
        ...
        $data['staffs'] = SmStaff::get(['first_name', 'last_name', 'full_name', 'id', 'user_id', 'parent_id']);
        $data['lead_city'] = [];
        $data['sources'] = [];
