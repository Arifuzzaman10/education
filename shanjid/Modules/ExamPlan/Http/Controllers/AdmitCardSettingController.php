...
class AdmitCardSettingController extends Controller
{
       ...
       try{
            ...
            if($request->data){
                ...
                foreach($student_records as $record){
                    ...
                    $admitcards = AdmitCard::whereIn('student_record_id',$student_records)->with('studentRecord')->get();
    ...
    {
        $admit_setting = AdmitCardSetting::first();
        
       if($request){
            $admit_setting->admit_layout = $request->layout; 
            $admit_setting->save();
