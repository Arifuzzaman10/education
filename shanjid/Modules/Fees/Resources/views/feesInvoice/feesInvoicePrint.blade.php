            ...
            <div class="invoice_wrapper">
                    ...
                    <table class="table border_table mb_30 description_table" >
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td colspan="2">
                                <p class="total_count"><span>@lang('fees::feesModule.total_service_charge')</span> <span>{{generalSetting()->currency_symbol}}{{number_format($service_charge, 2, '.', '')}}</span></p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
                        ...
                        <tr>
                            <td colspan="5"></td>
                            <td colspan="2">
                                <p class="total_count"><span>@lang('accounts.grand_total')</span> <span>{{generalSetting()->currency_symbol}}{{number_format($grand_total + $service_charge, 2, '.', '')}}</span></p>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5"></td>
