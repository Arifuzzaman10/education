            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                        ...
                        @if(moduleStatusCheck('University'))
                            <li class="nav-item">
                                    <a class="nav-link" href="#parentPanelExamTranscript" role="tab" data-toggle="tab">@lang('university::un.transcript')</a>
                            </li>
                        @endif
                        <li class="nav-item">
                                    ...
                                    <div class="white-box no-search no-paginate no-table-info mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 text-right">
                                                {{-- <a class="primary-btn small fix-gr-bg modalLink" data-modal-size="modal-lg" title="@lang('fees.add_fees')" href="{{route('student-direct-fees-total-payment', [$record->id])}}"0>  <i class="ti-plus pr-2"> </i> @lang('fees.add_fees') </a> --}}
                                            </div>
                                            @endif

                                            @if(moduleStatusCheck('University'))
                                                <div class="col-lg-8 mb-10">
                                                    <table class="display school-table school-table-style res_scrol school-table-up-style" cellspacing="0" width="100%">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            @foreach($record->fees as $assign_fees)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{generalSetting()->currency_symbol}} {{$assign_fees->fees_amount}}</td>
                                                                </tr>
                                                            @endforeach
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <th></th>
                                                                    <th>{{generalSetting()->currency_symbol}} {{$gt_fees}}</th>
                                                                </tr>
                                                            </tfoot>
                                                        </tbody>
                                                    </table>
                                        ...
                                        @if($exam->examSettings->publish_date <=  $today)
                                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                                ...
                                                @endforeach
                                                    ...
                                                    <tr>
                                                        <th></th>
                                                        <th>@lang('exam.position'): {{getStudentMeritPosition($record->class_id, $record->section_id, $exam->id, $record->id) ?? "null"}}</th>
                                                        <th>
