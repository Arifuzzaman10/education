...
@section('title') 
    @lang('lang.virtual_class') @lang('lang.details')
@endsection
@section('mainContent')
<style>
    .propertiesname{
        ...
        <div class="row">
            ...
            @if(userPermission(562))
                <div class="col-md-2 pull-right  text-right">
                    <a href="{{ route('zoom.virtual-class.edit', $localMeetingData->id) }}" class="primary-btn small fix-gr-bg "> <span class="ti-pencil-alt"></span> @lang('lang.edit') </a>
                </div>
            @endif
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        <table id="" class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td>{{ $sl++ }} </td>
                                 <td class="propertiesname">@lang('lang.password')</td>
                            ...
                            @if(userPermission(564))
                                <tr>
                                    <td>{{ $sl++ }} </td> <td class="propertiesname">@lang('lang.join_url')</td> <td> <a href="{{@$results['join_url']}}" target="_blank" >@lang('lang.click_here')</a></td>
                                </tr>
                            @endif
                            <tr>
                                <td>{{ $sl++ }} </td> <td class="propertiesname">@lang('lang.password')</td> <td>{{@$results['h323_password']}}</td>
                            </tr>
                            ...
                            <tr>
                                <td>{{ $sl++ }} </td> <td class="propertiesname">@lang('lang.mute_upon_entry')</td> <td>{{@$results['settings']['mute_upon_entry']==false?'False':'True'}}</td>
                            </tr>

                            <tr>
                                <td>{{ $sl++ }} </td> <td class="propertiesname">@lang('lang.watermark')</td> <td>{{@$results['settings']['watermark']==false?'False':'True'}}</td>
                            </tr>
