@if (in_array(561, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )
<div class="col-lg-3">
    ...
    @if(isset($editdata))
        <form class="form-horizontal" action="{{ route('zoom.meetings.update',$editdata->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
    @else
        @if(userPermission(556))
            <form class="form-horizontal" action="{{ route('zoom.meetings.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
        @endif
    @endif
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    <div class="row mb-30">
                        <div class="col-lg-12 ">
                            <select class="niceSelect w-100 bb user_type form-control{{ $errors->has('user_type') ? ' is-invalid' : '' }}" name="member_type">
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12" id="selectTeacherDiv">
                            <label for="checkbox" class="mb-2">@lang('lang.member') *</label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-6">
                                <label>@lang('lang.date_of_meeting')<span>*</span></label>
                            ...
                            <div class="col-lg-6">
                                    <label>@lang('lang.time_of_meeting')<span>*</span></label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    <input  type="number" oninput="numberCheck(this)" class="primary-input form-control{{ $errors->has('durration') ? ' is-invalid' : '' }}"
                                    type="text" name="durration" autocomplete="off" value="{{isset($editdata)? old('durration',$editdata->meeting_duration) : old('durration')}}">
                                    <label>@lang('lang.meeting_durration')<span>*</span></label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    <input type="number"  oninput="numberCheck(this)" class="primary-input form-control{{ $errors->has('time_start_before') ? ' is-invalid' : '' }}"
                                    type="text" name="time_start_before" autocomplete="off" value="{{isset($editdata)? old('time_start_before',$editdata->time_before_start) : 10}}">
                                    <label>@lang('lang.meeting') @lang('lang.start') @lang('lang.before')</label>
                                    <span class="focus-border"></span>
