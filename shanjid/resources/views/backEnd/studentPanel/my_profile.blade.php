    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-3 mb-30">
                ...
                @if (moduleStatusCheck('University'))
                    @includeIf('university::promote.inc.student_profile',['student_detail'=>$student_detail->defaultClass, 'setting'=>null])
                @else
            ...
            <div class="col-lg-9">
                <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                    ...
                    @if(userPermission(19) && moduleStatusCheck('University'))
                        <li class="nav-item">
