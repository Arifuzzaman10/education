...
class CreateSmHomePageSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $s->title = 'THE ULTIMATE EDUCATION SYSTEM';
        $s->long_title = 'SHANJID';
        $s->short_description = 'Managing various administrative tasks in one place is now quite easy and time savior with this SHANJID and Give your valued time to your institute that will increase next generation productivity for our society.';
