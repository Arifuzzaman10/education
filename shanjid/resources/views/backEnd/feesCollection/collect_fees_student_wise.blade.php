                ...
                <table id="" class="display school-table school-table-style-parent-fees" cellspacing="0" width="100%">
                    ...
                    <tfoot>
                      <tr>
                          ...
                          <th>{{@generalSetting()->currency_symbol}} {{ $total_balance}}</th>
                          <th></th>
                      </tr>
                  </tfoot>
                    ...
                    <tbody>
                          ...
                          <tr>
                            <td>
                              ...
                              <td>
                                  {{discountFees($feesInstallment->id) - ($feesInstallment->payments->sum('total_paid') + $feesInstallment->paid_amount) }} </td>
