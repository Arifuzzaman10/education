            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('fees.fees_collection_details')| <strong>{{dateConvert($date_from). "-" . dateConvert($date_to)}} </strong></h3>
                        </div>
                    </div>
                </div>
                <div class="row mt-35">
                        ...
                        <table id="table_id" class="display school-table " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('fees.paid_amount') ({{generalSetting()->currency_symbol}})</th>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    @if(userPermission(117))
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="{{route('fees_collect_student_wise', [$fees_payment->recordDetail->id])}}">@lang('common.view')</a>
                                                        </div>
                                                    @endif
                                                </div>
                                            </td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td>{{generalSetting()->currency_symbol}} {{$totalPaidAmountGrup + $totalPaidAmount}}</td>
                                    <td>{{generalSetting()->currency_symbol}} {{$totalDiscountGrup + $totalDiscount}}</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    @if(userPermission(117))
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="{{route('fees_collect_student_wise', [$fees_payment->installmentAssign->recordDetail->id])}}">@lang('common.view')</a>
                                                        </div>
                                                    @endif
                                                </div>
                                            </td>
