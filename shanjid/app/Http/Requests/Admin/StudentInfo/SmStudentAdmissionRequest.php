    ...
    public function rules()
    {
        ...
        $rules= [
            ...
            'fathers_name'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('fathers_name', $field);
            }),'max:100'],
            'fathers_occupation'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('fathers_occupation', $field);
            }),'max:100'],
            'fathers_phone'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('fathers_phone', $field);
            }),'max:100'],
            'fathers_photo'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('fathers_photo', $field);
            }),'sometimes','nullable','file','mimes:jpg,jpeg,png','max:'.$maxFileSize],
            'mothers_name'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('mothers_name', $field);
            }),'max:100'],
            'mothers_occupation'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('mothers_occupation', $field);
            }),'max:100'],
            'mothers_phone'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('mothers_phone', $field);
            }),'max:100'],
            'mothers_photo'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('mothers_photo', $field);
            }),'nullable','mimes:jpg,jpeg,png'],
            'guardians_name' =>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('guardians_name', $field);
            }),'max:100'],
            'relation'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('relation', $field);
            })],

            'guardians_photo' =>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('guardians_photo', $field);
            }), 'sometimes','nullable','file','mimes:jpg,jpeg,png','max:'.$maxFileSize],

            'guardians_occupation'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('guardians_occupation', $field);
            }), 'max:100'],
            'guardians_address' => [Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && in_array('guardians_address', $field);
            }),'max:200'],
