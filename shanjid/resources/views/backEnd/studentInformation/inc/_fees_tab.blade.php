        ...
        <div class="white-box no-search no-paginate no-table-info mb-2">
            <div class="row">
                ...
                <div class="col-lg-6 mb-10">
                    <table class="display school-table school-table-style res_scrol school-table-up-style"
                        ...
                        <tbody>
                            @foreach ($record->fees as $assign_fees)
                                ...
                                <tr>
                                    ...
                                    <td>{{ generalSetting()->currency_symbol }}
                                        {{ @$assign_fees->feesGroupMaster->amount }}</td>
                                </tr>
                            @endforeach
