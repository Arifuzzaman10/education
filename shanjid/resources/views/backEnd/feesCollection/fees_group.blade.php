                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                @if(userPermission(126))
                                                    @if(!@$fees_group->un_semester_label_id)
                                                        <a class="dropdown-item deleteFeesGroupModal" data-toggle="modal" data-target="#deleteFeesGroupModal" href="#" data-id="{{$fees_group->id}}">
                                                            @lang('common.delete') {{$fees_group}}
                                                        </a>
                                                    @endif
                                                @endif
                                            </div>
