                                                        ...
                                                        <tr>
                                                            ...
                                                            @else
                                                                <td colspan="{{$colspan / $col_for_result + 9}}"
                                                                    ...
                                                                    {{gradeName(number_format(termWiseFullMark($assinged_exam_types, $studentDetails->id),2,'.',''))}}
                                                                </td>
                                                            @endif
                                                        </tr>
                                                        {{-- Total Gpa Start --}}
                                                        <tr>
                                                            ...
                                                            @else
                                                                <td colspan="{{$colspan / $col_for_result + 9}}"
                                                                    class="text-center"
                                                                    style="padding:10px; font-weight:bold">
                                                                    {{number_format(termWiseFullMark($assinged_exam_types, $studentDetails->id),2,'.','')}}
                                                                </td>
                                                            @endif
                                                        </tr>
                                                        {{-- Total Gpa End --}}
                                                        ...
                                                        <tr>
                                                            ...
                                                            @else
                                                                ...
                                                                <td colspan="{{$colspan / $col_for_result + 9}}" class="text-center" style="padding:10px; font-weight:bold">
                                                                    {{remarks(number_format(termWiseFullMark($assinged_exam_types, $studentDetails->id),2,'.',''))}}
                                                                </td>
                                                            @endif
                                                        </tr>
                                                        {{-- Remark End --}}
