...
class CreateSmGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_general_settings', function (Blueprint $table) {
            ...
            $table->string('system_version')->nullable()->default('6.7.1');
        ...
        DB::table('sm_general_settings')->insert([
            [
                'copyright_text' => 'Copyright &copy; 2023 All rights reserved | This application is made by Arifuzzaman Raihan Powerd by DATA DSS',
                'logo' => 'public/uploads/settings/logo.png',
                'favicon' => 'public/uploads/settings/favicon.png',
                'phone' => '+8801747912663',
                'school_code' => '2201',
                'email' => 'raihanarifuzzaman@gmail.com',
                'address' => '89/2 Kawran Bazar, Dhaka 1215, Bangladesh',
                'currency' => 'TAKA',
                'currency_symbol' => '৳',
                'school_name' => 'Shanjid Edu',
                'site_title' => 'Shanjid Education software',
                'session_id' => 1,
                'time_zone_id' => 51,
